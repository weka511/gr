...
\begin{figure}[H]
	...
	\node [draw,text width=5cm] at (6,3) {The curve should be read as intersecting $\cal{J}^\pm$ at a right angle. In addition, it should \emph{not} be interpreted as an hyperbola, even though I used one to generate the graph.};
	\end{tikzpicture}
	\caption{Penrose-Carter Diagram for Steady Acceleration}
	\label{fig:pc}
\end{figure}
