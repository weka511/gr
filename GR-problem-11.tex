...
R_{\chi\chi}=&2 \text{, from \eqref{eq:R-r-r}}\\
R_{\theta\theta} =& 2 \sin\chi^2 \text{, from \eqref{eq:R-theta-theta}}\\
R_{\phi\phi} =&  2 \sin\chi^2 \sin^2\theta \text{, from \eqref{eq:R-phi-phi}}  \numberthis\label{eq:ricci-2}\\
R_{\theta\phi}=&R_{\phi\theta}=0\\
R_{\phi r}=&R_{r\phi}=0\\
R_{r\theta}=&R_{\theta r}=0
\end{empheq}
